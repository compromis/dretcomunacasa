...
useHead({
  htmlAttrs: { lang: head.value.htmlAttrs.lang, dir: head.value.htmlAttrs.dir, class: 'bg-blue text-white' },
  meta: [
    { name: 'theme-color', content: '#1F4C90' },
    { name: 'msapplication-TileColor', content: '#1F4C90' },
    ...head.value.meta
  ],
  link: [
